    ...
    <body>
        ...
        ?>
                            ...
                            <div id="default-tab-content">
                                <div class="overflow-x-auto overflow-y-hidden p-4 rounded-lg bg-gray-50" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    <div class="flex justify-start items-center p-4">
                                        <button id="addListBtn" class=" text-blue-500 px-4  rounded hover:bg-blue-50 transition">
                                            <!-- + Add List -->
                                        </button>
                    ...
                    <div id="cardDetailsModal" data-card-id="2" class="fixed inset-0 bg-black/30 flex items-start justify-center z-50 hidden">
                        ...
                        <div class="bg-white w-full max-w-5xl mt-20 p-6 rounded shadow-xl relative flex gap-6 max-h-[90vh] overflow-y-auto pb-5">
                            ...
                            <div class="w-1/4 space-y-4 text-sm text-gray-700">
                                <!-- Trigger -->
                                <div id="datesToggle" class="cursor-not-allowed border border-gray-300 px-3 py-2 rounded bg-gray-100 text-sm font-medium flex items-center gap-2 shadow-sm opacity-50">
                                ...
                                <!-- 👥 Members Toggle -->
                                <div id="membersToggle" class="cursor-not-allowed border border-gray-300 px-3 py-2 rounded bg-gray-100 text-sm font-medium flex items-center gap-2 shadow-sm opacity-50">
                                ...
                                <div id="checklistToggle" class="cursor-not-allowed border border-gray-300 px-3 py-2 rounded bg-gray-100 text-sm font-medium flex items-center gap-2 shadow-sm opacity-50">
                                    <i class="fas fa-tasks text-gray-600"></i>
                                    Checklist (Disabled)
                                </div>
            ...
            <script>
                ...
                <script src="../asset/js/kanban_member.js"></script>
                <script>
