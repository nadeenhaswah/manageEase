                    ...
                    <div class="col-6">
                        ...
                        <div class="form-container">
                            ...
                            if (isset($_GET['id'])) {
                                ...
                                $sql = "SELECT * FROM users WHERE id='$member_id' and added_by='$id'";
                            ...
                            ?>
                                    <form action="add_member_process.php" method="POST">
                                        ...
                                        <div class="line switch">
                                            <div class="input-fulid">
                                                <label><i class="fa-solid fa-briefcase"></i> Job</label>
                                                <br>
                                                <input type="test" name="job" value="<?= $member['job']; ?>">
                                        ...
                                        <div class="line">
                                            <div class="input-fulid">
                                                <label><i class="fa-solid fa-users-gear"></i> Role </label>
                                                <br>
                                                <select id="role" class="form-select form-select-sm bg-secondary-subtle" name="role" aria-label="Small select example">
