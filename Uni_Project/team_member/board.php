            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 mt-3 d-flex  flex-row justify-content-start align-items-start flex-wrap cursor-pointer ">
                        <?php
                        // استعلام لاسترجاع المشاريع التي يكون العضو الحالي عضوًا فيها
                        $sql = "SELECT id, name FROM projects 
                                WHERE created_by = '$user' 
                                OR FIND_IN_SET('$user', members) > 0
                                OR FIND_IN_SET('$user', project_managers) > 0";
                        ...
                        <?php
                            ...
                            echo "<p class='text-center w-100'>You are not a member in any projects yet.</p>";
                        }
                        ?>
                    </div>
                </div>
